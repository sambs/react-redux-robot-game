...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameApp = __webpack_require__(188);
	
	var _GameApp2 = _interopRequireDefault(_GameApp);
	
	var store = (0, _redux.applyMiddleware)(_reduxThunk2['default'])(_redux.createStore)(_reducers.game);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        { store: store },
	        function () {
	          return _react2['default'].createElement(_GameApp2['default'], null);
	        }
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvideDecorator = __webpack_require__(164);
	
	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);
	
	var _createConnector = __webpack_require__(166);
	
	var _createConnector2 = _interopRequireDefault(_createConnector);
	
	var _createConnectDecorator = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsComposeMiddleware = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsPick = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composeMiddleware = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsDirections = __webpack_require__(186);
	
	var directions = _interopRequireWildcard(_constantsDirections);
	
	var _constantsActionTypes = __webpack_require__(187);
	...
	var defaultState = {
	  ...
	  movesLeft: 10,
	  macros: [[types.MOVE_FORWARD, types.MOVE_FORWARD, types.ROTATE_ANTICLOCKWISE], [types.MOVE_FORWARD, types.ROTATE_CLOCKWISE, types.MOVE_FORWARD]]
	};
	...
	function game(state, action) {
	  ...
	  switch (action.type) {
	    case types.EXEC_MACRO:
	      var macroActions = state.macros[action.index];
	      return macroActions.reduce(function (mstate, type) {
	        return game(mstate, { type: type });
	      }, _extends({}, state, { movesLeft: state.movesLeft - 1 }));
	
	    case types.MOVE_FORWARD:
	      var vector = directions.VECTORS[state.player.direction];
	    ...
	    case types.ROTATE_CLOCKWISE:
	      var rcIndex = (directions.ALL.indexOf(state.player.direction) + 1) % 4;
	      player = _extends({}, state.player, {
	    ...
	    case types.ROTATE_ANTICLOCKWISE:
	      var racIndex = (directions.ALL.indexOf(state.player.direction) + 3) % 4;
	      player = _extends({}, state.player, {
	  ...
	  var movesLeft = action.isMove ? state.movesLeft - 1 : state.movesLeft;
	
	  var validPosition = !(state.blocks.some(function (block) {
	    return block.x === player.position.x && block.y === player.position.y;
	  }) || player.position.x < 0 || player.position.x >= state.board.width || player.position.y < 0 || player.position.y >= state.board.height);
	
	  var diamonds = state.diamonds.filter(function (diamond) {
	    return !(diamond.x === player.position.x && diamond.y === player.position.y);
	  });
...
/***/ function(module, exports) {
	...
	exports.ALL = ALL;
	var VECTORS = (_VECTORS = {}, _defineProperty(_VECTORS, NORTH, { x: 0, y: 1 }), _defineProperty(_VECTORS, EAST, { x: 1, y: 0 }), _defineProperty(_VECTORS, SOUTH, { x: 0, y: -1 }), _defineProperty(_VECTORS, WEST, { x: -1, y: 0 }), _VECTORS);
...
/***/ function(module, exports) {
	...
	exports.MOVE_FORWARD = MOVE_FORWARD;
	var ROTATE_CLOCKWISE = 'ROTATE_CLOCKWISE';
	exports.ROTATE_CLOCKWISE = ROTATE_CLOCKWISE;
	var ROTATE_ANTICLOCKWISE = 'ROTATE_ANTICLOCKWISE';
	exports.ROTATE_ANTICLOCKWISE = ROTATE_ANTICLOCKWISE;
	var EXEC_MACRO = 'EXEC_MACRO';
	exports.EXEC_MACRO = EXEC_MACRO;
	var RESTART = 'RESTART';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsGame = __webpack_require__(189);
	
	var _componentsGame2 = _interopRequireDefault(_componentsGame);
	
	var _actionsGameActions = __webpack_require__(197);
	...
	var GameApp = (function (_Component) {
	  ...
	  function GameApp() {
	    _classCallCheck(this, _GameApp);
	
	    _get(Object.getPrototypeOf(_GameApp.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(GameApp, [{
	    ...
	    value: function render() {
	      ...
	      var props = _extends({}, this.props, (0, _redux.bindActionCreators)(GameActions, dispatch));
	      return _react2['default'].createElement(_componentsGame2['default'], props);
	    }
	  }]);
	
	  var _GameApp = GameApp;
	  GameApp = (0, _reactRedux.connect)(function (state) {
	    return state;
	  })(GameApp) || GameApp;
	  return GameApp;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Status = __webpack_require__(194);
	
	var _Status2 = _interopRequireDefault(_Status);
	
	var _RestartButton = __webpack_require__(196);
	...
	var Game = (function (_Component) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function render() {
	      ...
	      var diamonds = _props.diamonds;
	      var validPosition = _props.validPosition;
	      var scale = _props.scale;
	      var complete = _props.complete;
	      var failed = _props.failed;
	      var movesLeft = _props.movesLeft;
	      var restart = _props.restart;
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: "game", style: gameStyle },
	        _react2['default'].createElement(
	          'h1',
	          null,
	          'Robot'
	        ),
	        _react2['default'].createElement(_Board2['default'], { size: board,
	          scale: scale,
	          player: player,
	          validPosition: validPosition,
	          diamonds: diamonds,
	          blocks: blocks }),
	        _react2['default'].createElement(_Status2['default'], { complete: complete, failed: failed, movesLeft: movesLeft }),
	        _react2['default'].createElement(_RestartButton2['default'], { complete: complete, failed: failed, restart: restart })
	      );
	    }
	  }], [{
	    key: 'defaultProps',
	    ...
	    key: 'propTypes',
	    value: {
	      board: _react.PropTypes.object.isRequired,
	      player: _react.PropTypes.object.isRequired,
	      validPosition: _react.PropTypes.bool.isRequired,
	      complete: _react.PropTypes.bool.isRequired,
	      failed: _react.PropTypes.bool.isRequired,
	      movesLeft: _react.PropTypes.number.isRequired,
	      moveForward: _react.PropTypes.func.isRequired,
	      rotateClockwise: _react.PropTypes.func.isRequired,
	      rotateAnticlockwise: _react.PropTypes.func.isRequired,
	      execMacro: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Diamond = __webpack_require__(192);
	
	var _Diamond2 = _interopRequireDefault(_Diamond);
	
	var _Block = __webpack_require__(193);
	  ...
	  _createClass(Board, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        diamonds.map(function (diamond, index) {
	          return _react2['default'].createElement(_Diamond2['default'], { key: 'diamond' + index, position: diamond, scale: scale });
	        }),
	        blocks.map(function (block, index) {
	          return _react2['default'].createElement(_Block2['default'], { key: 'block' + index, position: block, scale: scale });
	        }),
	        _react2['default'].createElement(_Player2['default'], { position: player.position,
	    ...
	    value: {
	      ...
	      diamonds: _react.PropTypes.array.isRequired,
	      validPosition: _react.PropTypes.bool.isRequired
	    },
	    enumerable: true
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ICON_CLASSES = (_ICON_CLASSES = {}, _defineProperty(_ICON_CLASSES, directions.NORTH, 'fa fa-chevron-circle-up'), _defineProperty(_ICON_CLASSES, directions.EAST, 'fa fa-chevron-circle-right'), _defineProperty(_ICON_CLASSES, directions.SOUTH, 'fa fa-chevron-circle-down'), _defineProperty(_ICON_CLASSES, directions.WEST, 'fa fa-chevron-circle-left'), _ICON_CLASSES);
	...
	var Player = (function (_Component) {
	  ...
	  _createClass(Player, [{
	    ...
	    value: function renderIcon() {
	      ...
	      var validPosition = _props2.validPosition;
	
	      if (validPosition) return _react2['default'].createElement('i', { className: ICON_CLASSES[direction] });else return _react2['default'].createElement('i', { className: "invalid-position fa fa-times" });
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Diamond = (function (_Component) {
	  _inherits(Diamond, _Component);
	
	  function Diamond() {
	    _classCallCheck(this, Diamond);
	
	    _get(Object.getPrototypeOf(Diamond.prototype), 'constructor', this).apply(this, arguments);
	  }
	...
	var Block = (function (_Component) {
	  ...
	  _createClass(Block, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement("div", { className: "block", style: style });
	    }
	  }], [{
	    key: "propTypes",
	    value: {
	...
	var Status = (function (_Component) {
	  ...
	  _createClass(Status, [{
	    ...
	    value: function render() {
	      ...
	      var movesLeftText = movesLeft + ' moves remaining';
	
	      if (complete) return _react2['default'].createElement(
	        'div',
	        { className: className },
	        'You did it!',
	        ...
	        movesLeftText,
	        ')'
	      );else if (!movesLeft) return _react2['default'].createElement(
	        'div',
	        { className: className },
	        'Out of moves!'
	      );else if (!failed) return _react2['default'].createElement(
	        'div',
	        { className: className },
	        movesLeftText
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RestartButton = (function (_Component) {
	  ...
	  function RestartButton() {
	    ...
	    _get(Object.getPrototypeOf(RestartButton.prototype), 'constructor', this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rotateAnticlockwise = rotateAnticlockwise;
	exports.execMacro = execMacro;
	exports.restart = restart;
